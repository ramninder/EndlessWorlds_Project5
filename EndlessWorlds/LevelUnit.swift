...
class LevelUnit:SKNode {
    ...
    @objc var backgroundSprite:SKSpriteNode = SKSpriteNode()
    @objc var levelUnitWidth:CGFloat = 0
    @objc var levelUnitHeight:CGFloat = 0
    var theType:LevelType = LevelType.ground
    
    @objc var xAmount:CGFloat = 1  //essentially this is our speed
    @objc var direction:CGFloat = 1 //will be saved as either 1 or -1
    @objc var numberOfObjectsInLevel:UInt32 = 0
    @objc var offscreenCounter:Int = 0 //anytime an object goes offscreen we add to this, for resetting speed purposes
    @objc var topSpeedgrass:UInt32 = 5
    @objc var topSpeedWater:UInt32 = 2
    @objc var maxObjectsInLevelUnit:UInt32 = 2
    
    @objc var isFirstUnit:Bool = false
